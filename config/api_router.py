...
from apps.users.views.api import AddressViewSet, CityViewSet, DepartmentViewSet, UserViewSet
...
router.register('geo/departamentos', DepartmentViewSet, basename='departamentos')
router.register('geo/municipios', CityViewSet, basename='municipios')
